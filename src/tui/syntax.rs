    ...
    match lang {
        Language::Rust => {
            keywords = vec![
                ...
                "loop", "break", "continue", "return", "struct", "enum", "impl", "trait", "use",
                "pub", "mod", "crate", "super", "self", "where", "async", "await", "move", "ref",
                "type", "unsafe", "async", "await", "dyn", "box", "as", "in",
            ];
            types = vec![
                "bool",
                "char",
        ...
        Language::Python => {
            keywords = vec![
                ...
                "pass", "lambda", "yield", "async", "await", "global", "nonlocal", "assert", "del",
        ...
        Language::JavaScript | Language::TypeScript => {
            ...
            types = vec![
                ...
                "never", "void", "Array", "Promise", "Map", "Set", "Date", "RegExp", "Error",
                "Function", "String", "Number", "Boolean", "Object",
            ];
        }
        Language::Go => {
            keywords = vec![
        ...
        Language::Bash => {
            keywords = vec![
                ...
                "source", "alias", "declare", "local", "readonly", "shift", "test", "true",
                "false",
            ];
            types = vec![];
        }
...
mod tests {
    ...
    fn test_string_highlighting() {
        ...
        assert!(
            string_span.is_some(),
            "Should find string literal in output"
        );
    }
    ...
    fn test_multi_language_support() {
        ...
        assert!(
            func_span.is_some(),
            "Should find 'function' keyword in JavaScript"
        );
    }
